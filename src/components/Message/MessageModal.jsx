      ...
      <div className="fixed left-0 top-0 z-10 flex h-screen w-full items-center justify-center bg-black bg-opacity-20 text-center">
        <div className="flex h-80 w-80 flex-col justify-center bg-message-image bg-cover">
          <div className="mt-5 p-10 ">
            <div className="font-omyu_pretty flex h-52 w-60 flex-col justify-between overflow-auto">
              <p className="message-content text-lg">{message.content}</p>
              <p className="font-omyu_pretty text-right">
                - {message.nickname} -
              </p>
            </div>
            <button
